(this['webpackJsonpmesto-react'] = this['webpackJsonpmesto-react'] || []).push([[0], {
  15(e, t, n) {},
  16(e, t, n) {
    n.r(t); const a = n(0); const c = n(1); const r = n.n(c); const o = n(6); const i = n.n(o); const s = (n(15), n(9)); const l = n(2); const d = `${n.p}static/media/header-logo.c2821b38.svg`; const u = function () { return Object(a.jsx)('header', { className: 'header', children: Object(a.jsx)('img', { className: 'header__logo', src: d, alt: '\u041b\u043e\u0433\u043e\u0442\u0438\u043f \u0441\u0435\u0440\u0432\u0438\u0441\u0430 Mesto' }) }); }; const m = r.a.createContext(); const j = function (e) {
      ...
      return Object(a.jsx)(a.Fragment, {
        children: Object(a.jsx)('div', {
          ...
          children: Object(a.jsxs)('form', {
            name: '', action: '#', className: 'modal__container modal__container_type_'.concat(e.name), noValidate: !0, onSubmit: e.onSubmit, children: [Object(a.jsx)('h2', { className: 'modal__title', children: e.title }), e.children, Object(a.jsx)('button', { type: 'submit', className: 'modal__save-button', children: e.buttonText || '\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c' }), Object(a.jsx)('button', { type: 'reset', className: 'modal__close-button', onClick: e.onClose })],
          }),
        }),
      });
    }; const x = function (e) {
      const t = r.a.useState(''); const n = Object(l.a)(t, 2); const c = n[0]; const o = n[1]; const i = r.a.useState(''); const s = Object(l.a)(i, 2); const d = s[0]; const u = s[1]; const j = r.a.useContext(m); return r.a.useEffect((() => { o(j.name), u(j.about); }), [j]), Object(a.jsxs)(v, {
        isOpen: e.isOpen,
        name: 'edit-profile',
        title: '\u0420\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u043f\u0440\u043e\u0444\u0438\u043b\u044c',
        onClose: e.onClose,
        onSubmit(t) { t.preventDefault(), e.onUpdateUser({ name: c, description: d }); },
        children: [Object(a.jsx)('input', {
          ...
          id: 'description-input', name: 'description', type: 'text', className: 'modal__input modal__input_type_description', required: !0, value: d, onChange(e) { u(e.target.value); }, placeholder: '\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043e\u043f\u0438\u0441\u0430\u043d\u0438\u0435', minLength: '2', maxLength: '200',
      ...
      const t = r.a.useState(''); const n = Object(l.a)(t, 2); const c = n[0]; const o = n[1]; const i = r.a.useState(''); const s = Object(l.a)(i, 2); const d = s[0]; const u = s[1]; return Object(a.jsxs)(v, {
        isOpen: e.isOpen,
        name: 'add-element',
        title: '\u041d\u043e\u0432\u043e\u0435 \u043c\u0435\u0441\u0442\u043e',
        onClose: e.onClose,
        onSubmit(t) { t.preventDefault(), e.onAddPlace({ name: c, description: d }); },
        children: [Object(a.jsx)('input', {
          id: 'name-input', name: 'name', type: 'text', className: 'modal__input modal__input_type_place', required: !0, value: c, onChange(e) { o(e.target.value); }, placeholder: '\u041d\u0430\u0437\u0432\u0430\u043d\u0438\u0435', minLength: '1', maxLength: '30',
        }), Object(a.jsx)('span', { id: 'name-input-error', className: 'modal__input-error' }), Object(a.jsx)('input', {
          id: 'description-input', name: 'description', type: 'url', className: 'modal__input modal__input_type_url', required: !0, value: d, onChange(e) { u(e.target.value); }, placeholder: '\u0421\u0441\u044b\u043b\u043a\u0430 \u043d\u0430 \u043a\u0430\u0440\u0442\u0438\u043d\u043a\u0443',
        }), Object(a.jsx)('span', { id: 'description-input-error', className: 'modal__input-error' })],
      });
    }; const k = function () {
      const e = r.a.useState([]); const t = Object(l.a)(e, 2); const n = t[0]; const c = t[1]; const o = r.a.useState(!1); const i = Object(l.a)(o, 2); const d = i[0]; const j = i[1]; const f = r.a.useState(!1); const b = Object(l.a)(f, 2); const v = b[0]; const k = b[1]; const N = r.a.useState(!1); const y = Object(l.a)(N, 2); const P = y[0]; const S = y[1]; const L = r.a.useState({}); const E = Object(l.a)(L, 2); const A = E[0]; const T = E[1]; const D = r.a.useState({}); const U = Object(l.a)(D, 2); const F = U[0]; const q = U[1]; function J() { j(!1), k(!1), S(!1), T({}); } return r.a.useEffect((() => { Promise.all([O.getUserInfo(), O.getAllCards()]).then(((e) => { const t = Object(l.a)(e, 2); const n = t[0]; const a = t[1]; q(n), c(a); })).catch(((e) => { console.log(e); })); }), []), Object(a.jsx)(a.Fragment, {
        children: Object(a.jsx)('div', {
          className: 'root',
          children: Object(a.jsx)(m.Provider, {
            ...
            children: Object(a.jsxs)('div', {
              ...
              children: [Object(a.jsx)(u, {}), Object(a.jsx)(h, {
                onEditAvatar() { j(!0); }, onEditProfile() { k(!0); }, onAddPlace() { S(!0); }, onCardClick(e) { T(e); }, onCardLike(e) { const t = e.likes.some(((e) => e._id === F._id)); O.changeLikeCardStatus(e._id, !t).then(((t) => { const a = n.map(((n) => (n._id === e._id ? t : n))); c(a); })).catch(((e) => { console.log(e); })); }, onCardDelete(e) { const t = e.owner._id === F._id; O.deleteCard(e._id, t).then((() => { const t = n.filter(((t) => e._id !== t._id)); c(t); })).catch(((e) => { console.log(e); })); }, cards: n,
              }), Object(a.jsx)(_, {}), Object(a.jsx)(C, { isOpen: d, onClose: J, onUpdateAvatar(e) { O.patchChangeAvatar(e).then(((e) => { q(e), J(); })).catch(((e) => { console.log(e); })); } }), Object(a.jsx)(x, { isOpen: v, onClose: J, onUpdateUser(e) { O.patchEditProfile(e).then(((e) => { q(e), J(); })).catch(((e) => { console.log(e); })); } }), Object(a.jsx)(g, { isOpen: P, onClose: J, onAddPlace(e) { O.postCard(e).then(((e) => { c([e].concat(Object(s.a)(n))), J(); })).catch(((e) => { console.log(e); })); } }), Object(a.jsx)(p, { card: A, onClose: J })],
            }),
          }),
        }),
      });
    }; const N = function (e) { e && e instanceof Function && n.e(3).then(n.bind(null, 17)).then(((t) => { const n = t.getCLS; const a = t.getFID; const c = t.getFCP; const r = t.getLCP; const o = t.getTTFB; n(e), a(e), c(e), r(e), o(e); })); }; i.a.render(Object(a.jsx)(r.a.StrictMode, { children: Object(a.jsx)(k, {}) }), document.getElementById('root')), N();
  },
}, [[16, 1, 2]]]);
// # sourceMappingURL=main.a4d3030f.chunk.js.map
